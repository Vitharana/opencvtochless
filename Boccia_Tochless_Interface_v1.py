...
print("###############################################################################################")
print("###############################################################################################")
input("\nPress Enter To Continue If Settings Are Ok : ")
...
with mp_hands.Hands(
  ...
  while cap.isOpened():
    ...
    cv2.imshow("Miura Research Laboratory v0.4", resized)
    ...
    if cv2.waitKey(5) & 0xFF == 27:
      break
    if cv2.getWindowProperty("Miura Research Laboratory v0.4", cv2.WND_PROP_VISIBLE) < 1:
      break
